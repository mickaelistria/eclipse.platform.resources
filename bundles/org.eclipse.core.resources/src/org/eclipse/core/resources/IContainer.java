...
public interface IContainer extends IResource, IAdaptable {
	...
	/**
	 * Returns a handle to a nested project identified by the given path in this
	 * container.
	 * <p>
	 * This is a resource handle operation; neither the resource nor
	 * the result need exist in the workspace.
	 ...
	 * </p>
	 *
	 * @param path the path of the member project
	 * @return the (handle of the) member project
	 * @see #getFile(IPath)
	 * @see #getFolder(IPath)
	 * @since 3.9
	 */
	public IProject getNestedProject(IPath path);
